...
void Sample3DSceneRenderer::CreateDeviceDependentResources()
{
	...
	auto createPSTask = loadPSTask.then([this](const std::vector<byte>& fileData) {
		...
		// Rasterizer State
		m_wireframeRasterDesc = CD3D11_RASTERIZER_DESC(D3D11_DEFAULT);
		...
		m_filledRasterDesc = CD3D11_RASTERIZER_DESC(D3D11_DEFAULT);
	...
	auto createCubeTask = (createPSTask && createVSTask && createHSTask && createDSTask && createGSParticleTask).then([this]() {
